pub static USERS_ROUTES: &str = "/users";
pub static AUTH_ROUTES: &str = "/auth";
pub static PROFILE_ROUTES: &str = "/profile";

// Store Routes
// Projects: Ecommerce Generico
pub static PRODUCTS_ROUTES: &str = "/store/products";
